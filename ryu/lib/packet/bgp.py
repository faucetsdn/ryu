...
BGP_ERROR_SUB_UNRECOGNIZED_WELL_KNOWN_ATTRIBUTE = 2
BGP_ERROR_SUB_MISSING_WELL_KNOWN_ATTRIBUTE = 3
BGP_ERROR_SUB_ATTRIBUTE_FLAGS_ERROR = 4
BGP_ERROR_SUB_ATTRIBUTE_LENGTH_ERROR = 5
BGP_ERROR_SUB_INVALID_ORIGIN_ATTRIBUTE = 6
# 7 is deprecated RFC 1771 AS Routing Loop
BGP_ERROR_SUB_INVALID_NEXT_HOP_ATTRIBUTE = 8
BGP_ERROR_SUB_OPTIONAL_ATTRIBUTE_ERROR = 9
...
BGP_ERROR_SUB_MAXIMUM_NUMBER_OF_PREFIXES_REACHED = 1
